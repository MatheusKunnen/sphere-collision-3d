...
class OpenGLManager:
    ...
    def draw_solid_sphere(self, sphere_pos, sphere_radius, sphere_ambient_color=sphere_ambient_color, diffuse_color=None):
        K = 5.
        if diffuse_color is None:
            diffuse_color = [sphere_ambient_color[0]*K,
